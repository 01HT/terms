...
Дата последнего изменения: 30 сентября 2018 г. | Версия 1.0.0 ([посмотреть предыдущие версии](https://github.com/01HT/terms/releases))
...
При работе с нашими Службами вы разрешаете нам использовать свою личную информацию в соответствии с [политикой конфиденциальности](/privacy) 01HT. В последней изложено, для чего мы применяем эти данные и как обеспечиваем конфиденциальность пользователей при работе со Службами.
...
Общедоступные данные вашего аккаунта 01HT (имя и фото в профиле), а также сведения о действиях, которые вы совершаете в сервисах 01HT или во внешних приложениях, связанных с вашим аккаунтом (например, об отзывах, комментариях и +1), могут быть использованы нами в коммерческих целях, в том числе в рекламе.
